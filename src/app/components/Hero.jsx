        ...
        <div className='container mx-auto px-12 py-4 mt-28'>
            <div className='grid grid-cols-1 sm:grid-cols-12'>
                <div className='col-span-7 place-self-center text-center sm:text-left'>
                    ...
                    <p className='text-[#adb7b3] text-base sm:text-lg lg:text-xl mb-6'>Passionate about machine learning, deep learning, and software development and creating meaningful experiences. Constantly learning, coding, and pushing the boundaries of what's possible.</p>
                </div>
